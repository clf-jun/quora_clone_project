        ...
        <div className='post_body'>
            <div className='post_question'>
                ...
                <Modal isOpen={openModal} onRequestClose={() => setOpenModal(false)}
                    ...
                    <textarea placeholder="답변을 작성해 주세요" type="text" value={answer} 
                    onChange={(e) => setAnswer(e.target.value)}/>                    
                    </div>
                    
                    <div className='modal_buttons'>                    
                        <button type="submit" className='add'
                        onClick={handleAnswer}>답변하기</button>
                                ...
                                <span>{answers.answer}
                                    ...
                                    <span style={{
                                        ...
                                        right: "0px",
                                            ...
                                            {answers.displayName ? answers.displayName : answers.email}
                                        </span>
                                            {" "}
...
//질문하기 눌렀을때 모달 팝업창을 띄우기 위해 post-modal 패키지를 추가